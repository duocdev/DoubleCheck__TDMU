!(function (t, e) {
    ...
    , (function (t) {
        ...
        196: function (t, e, n) {
            ...
            var l = ["transitionend", "webkitTransitionEnd", "oTransitionEnd"], c = ["transition", "MozTransition", "webkitTransition", "WebkitTransition", "OTransition"], d =
                "\n.layout-menu-fixed .layout-navbar-full .layout-menu,\n.layout-menu-fixed-offcanvas .layout-navbar-full .layout-menu {\n  top: {navbarHeight}px !important;\n}\n.layout-page {\n  padding-top: {navbarHeight}px !important;\n}\n.content-wrapper {\n  padding-bottom: {footerHeight}px !important;\n}";
            function f(t) {
                throw new Error("Parameter required".concat(t ? ": `".concat(t, "`") : ""));
            }
            var h = {
                ROOT_EL: "undefined" != typeof window ? document.documentElement : null, LAYOUT_BREAKPOINT: 1200, RESIZE_DELAY: 200, menuPsScroll: null, mainMenu: null, _curStyle: null, _styleEl: null, _resizeTimeout: null, _resizeCallback: null, _transitionCallback: null, _transitionCallbackTimeout: null, _listeners: [], _initialized: !1, _autoUpdate: !1, _lastWindowHeight: 0, _scrollToActive: function () {
                    var t = arguments.length > 0 && void 0 !== arguments[0] && arguments[0], e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 500, n = this.getLayoutMenu();
                    if (n) {
                ...
                , _toggleClass: function () {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.ROOT_EL, e = arguments.length > 1 ? arguments[1] : void 0, n = arguments.length > 2 ? arguments[2] : void 0;
                ...
                , _triggerEvent: function (t) {
                    this._triggerWindowEvent("layout".concat(t)), this._listeners
                        .filter(function (e) {
                            return e.event === t;
                        })
                        .forEach(function (t) {
                ...
                , _unbindLayoutAnimationEndEvent: function () {
                    ...
                    this._transitionCallbackTimeout && (clearTimeout(this._transitionCallbackTimeout), (this._transitionCallbackTimeout = null)), e &&
                ...
                , _bindMenuMouseEvents: function () {
                    ...
                    if (!(this._menuMouseEnter && this._menuMouseLeave && this._windowTouchStart)) {
                        ...
                        this._menuMouseEnter ||
                            ...
                            }), e.addEventListener("mouseenter", this._menuMouseEnter, !1), e.addEventListener("touchstart", this._menuMouseEnter, !1)), this._menuMouseLeave ||
                            ((this._menuMouseLeave = function () {
                                t._setMenuHoverState(!1);
                            }), e.addEventListener("mouseleave", this._menuMouseLeave, !1)), this._windowTouchStart ||
                ...
                , scrollPageTo: function (t) {
                    var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 500, n = function (t, e, n, i) {
                        return (t /= i / 2) < 1 ? (n / 2) * t * t + e : (-n / 2) * ((t -= 1) * (t - 2) - 1) + e;
                    }
                ...
                , setCollapsed: function () {
                    var t = this, e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : f("collapsed"), n = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1], i = this.getLayoutMenu();
                    i &&
                        (this._unbindLayoutAnimationEndEvent(), n && this._supportsTransitionEnd()
                            ? (this._addClass("layout-transitioning"), e && this._setMenuHoverState(!1), this._bindLayoutAnimationEndEvent(
                                function () {
                                    t._setCollapsed(e);
                                }
                ...
                , setPosition: function () {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : f("fixed"), e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : f("offcanvas");
                ...
                , on: function () {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : f("event"), e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : f("callback"), n = t.split("."), r = o(n, 1), s = r[0], a = t.split("."), u = i(a), l = u.slice(1);
                    (l = l.join(".") || null), this._listeners.push({ event: s, namespace: l, callback: e });
                }

                , off: function () {
                    var t = this, e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : f("event"), n = e.split("."), r = o(n, 1), s = r[0], a = e.split("."), u = i(a), l = u.slice(1);
                    (l = l.join(".") || null), this._listeners
                        .filter(function (t) {
                ...
                , init: function () {
                    var t = this;
                    this._initialized ||
                        ((this._initialized = !0), this._updateInlineStyle(0), this._bindWindowResizeEvent(), this.off("init._Helpers"), this.on("init._Helpers", function () {
                            ...
                            document.documentMode < 11 &&
                                (t.off("resize._Helpers:ie10RepaintBody"), t.on("resize._Helpers:ie10RepaintBody", function () {
                                    if (!t.isFixed()) {
                ...
                , destroy: function () {
                    var t = this;
                    this._initialized &&
                        ((this._initialized = !1), this._removeClass("layout-transitioning"), this._removeInlineStyle(), this._unbindLayoutAnimationEndEvent(), this._unbindWindowResizeEvent(), this._unbindMenuMouseEvents(), this.setAutoUpdate(!1), this.off("init._Helpers"), this._listeners
                            .filter(function (t) {
                                return "init" !== t.event;
                            })
                            .forEach(function (e) {
                    ...
                    null != t &&
                        t.forEach(function (t) {
                            t.addEventListener("click", function (e) {
                                e.preventDefault();
                                var n = t.closest(".form-password-toggle"), i = n.querySelector("i"), o = n.querySelector("input");
                ...
                , initSpeechToText: function () {
                    var t = window.SpeechRecognition || window.webkitSpeechRecognition, e = document.querySelectorAll(".speech-to-text");
                    if (null != t && null != e) {
                        var n = new t();
                ...
                , initNavbarDropdownScrollbar: function () {
                    var t = document.querySelectorAll(".navbar-dropdown .scrollable-container"), e = window.PerfectScrollbar;
                    void 0 !== e &&
                        null != t &&
                        t.forEach(function (t) {
                ...
                , initSidebarToggle: function () {
                    document.querySelectorAll('[data-bs-toggle="sidebar"]').forEach(function (t) {
                        t.addEventListener("click", function () {
                            var e = t.getAttribute("data-target"), n = t.getAttribute("data-overlay"), i = document.querySelectorAll(".app-overlay");
                            document.querySelectorAll(e).forEach(function (t) {
                                t.classList.toggle("show"), null != n &&
                                    !1 !== n &&
                                    void 0 !== i &&
                                    (t.classList.contains("show") ? i[0].classList.add("show") : i[0].classList.remove("show"), i[0].addEventListener("click", function (e) {
