    ...
    (function (t) {
        ...
        199: function (t, e, s) {
            ...
            var i = s(190)
                ...
                o = s.n(i);
            function a(t, e, s) {
                return e in t ? Object.defineProperty(t, e, { value: s, enumerable: !0, configurable: !0, writable: !0 }) : (t[e] = s)
                        ...
                        (s = [
                                ...
                                value: function (t) {
                                    ...
                                    if (this._hasControls("layoutType") && ("static" === t || "static-offcanvas" === t || "fixed" === t || "fixed-offcanvas" === t)) {
                                        ...
                                        "fixed" === this.settings.layoutType || "fixed-offcanvas" === this.settings.layoutType
                                            ? i && s && (window.Helpers.menuPsScroll.destroy()
                                    ...
                                    if (this._hasControls("showDropdownOnHover")) {
                                        if (((this.settings.showDropdownOnHover = t)
                                            ...
                                            window.Helpers.mainMenu = new i(document.getElementById("layout-menu")
                                                ...
                                                , { orientation: "horizontal", closeChildren: !0, showDropdownOnHover: config.showDropdownOnHover });
                                        }
                                        e && this.settings.onSettingsChange.call(this, this.settings);
                                    }
                                }
                                ...
                                value: function (e) {
                                    ...
                                    if (e !== this.settings.lang || i) {
                                        ...
                                        for (var a = o.themes || {}
                                            ...
                                            , n = this.container.querySelectorAll(".template-customizer-theme-item") || [], l = 0, r = n.length; l < r; l++) {
                            ...
                            ,
                            {
                                ...
                                value: function () {
                                    ...
                                    (t = "" !== r && -1 !== ["static", "static-offcanvas", "fixed", "fixed-offcanvas"].indexOf(r) ? r : this.settings.defaultLayoutType)
                                        ...
                                        ,
                                        (this.settings.theme = this._getThemeByName(this._getSetting("Theme")
                            ...
                            ,
                            {
                                ...
                                value: function (t, e) {
                                    ...
                                    try {
                                        localStorage.setItem("templateCustomizer-".concat(s, "--").concat(t)
