        ...
        return (
            (n.m = e), (n.c = t), (n.d = function (e, t, i) {
                ...
                if ((n.r(i), Object.defineProperty(i, "default",
                    { enumerable: !0, value: e }), 2 & t && "string" != typeof e))
                    for (var o in e)
                        n.d(
                            i, o, function (t) {
                                return e[t];
        ...
        198: function (e, t, n) {
            ...
            var l = ["transitionend", "webkitTransitionEnd", "oTransitionEnd"], a = (function () {
                function e(t) {
                    ...
                    if (
                        (r(this, e), (this._el = t), (this._horizontal = "horizontal" === n.orientation), (this._animate = !1 !== n.animate), (this._accordion = !1 !== n.accordion), (this._showDropdownOnHover = Boolean(n.showDropdownOnHover)), (this._closeChildren = Boolean(n.closeChildren)), (this._rtl = "rtl" === document.documentElement.getAttribute("dir") || "rtl" === document.body.getAttribute("dir")), (this._onOpen = n.onOpen || function () { }), (this._onOpened = n.onOpened || function () { }), (this._onClose = n.onClose || function () { }), (this._onClosed = n.onClosed || function () { }), (this._psScroll = null), (this._topParent = null), (this._menuBgClass = null), t.classList.add("menu"), t.classList[this._animate ? "remove" : "add"]("menu-no-animation"), this._horizontal)
                    ) {
                        t.classList.add("menu-horizontal"), t.classList.remove("menu-vertical"),
                            (this._inner = t.querySelector(".menu-inner"));
                        var o = this._inner.parentNode;
                        (this._prevBtn = t.querySelector(".menu-horizontal-prev")), this._prevBtn || ((this._prevBtn = document.createElement("a")),
                            (this._prevBtn.href = "#"),
                            (this._prevBtn.className = "menu-horizontal-prev"), o.appendChild(this._prevBtn)), (this._wrapper = t.querySelector(".menu-horizontal-wrapper")), this._wrapper || ((this._wrapper = document.createElement("div")),
                                (this._wrapper.className = "menu-horizontal-wrapper"), this._wrapper.appendChild(this._inner), o.appendChild(this._wrapper)), (this._nextBtn = t.querySelector(".menu-horizontal-next")), this._nextBtn || ((this._nextBtn = document.createElement("a")),
                                    (this._nextBtn.href = "#"),
                                    (this._nextBtn.className = "menu-horizontal-next"), o.appendChild(this._nextBtn)), (this._innerPosition = 0), this.update();
                    } else {
                        ...
                        s
                            ? ((this._scrollbar = new s(t.querySelector(".menu-inner"),
                                { suppressScrollX: !0, wheelPropagation: !e._hasClass("layout-menu-fixed layout-menu-fixed-offcanvas") })), (window.Helpers.menuPsScroll = this._scrollbar))
                    ...
                    t.setAttribute("data-bg-class", this._menuBgClass), this._horizontal && window.innerWidth < window.Helpers.LAYOUT_BREAKPOINT && this.switchMenu("vertical"), this._bindEvents(),
                        (t.menuInstance = this);
                }
                var t, n, o;
                return (
                    (t = e), (o = [
                        ...
                        ,
                        {
                            key: "_findMenu", value: function (e) {
                                for (var t = e.childNodes[0], n = null; t && !n;) t.classList && t.classList.contains("menu-sub") && (n = t),
                                    (t = t.nextSibling);
                        ...
                        ,
                        {
                            key: "_unbindAnimationEndEvent", value: function (e) {
                                ...
                                e._menuAnimationEndEventTimeout && (clearTimeout(e._menuAnimationEndEventTimeout),
                                    (e._menuAnimationEndEventTimeout = null)), t &&
                        ...
                        ,]), (n = [
                            {
                                key: "_bindEvents", value: function () {
                                    ...
                                    (this._evntElClick = function (n) {
                                    ...
                                    }), window.addEventListener("resize", this._evntWindowResize), this._horizontal &&
                                        ((this._evntPrevBtnClick = function (e) {
                                        ...
                                        }), document.body.addEventListener("click", this._evntBodyClick), this._showDropdownOnHover &&
                                            ((this._evntElMouseOver = function (e) {
                                                ...
                                                if (
                                                    (o.closest("ul") && o.closest("ul").classList.contains("menu-inner") && (t._topParent = o), o !== i && (o.parentNode.classList.contains("open") || !o.classList.contains("menu-toggle")) && r && r.parentNode && !r.parentNode.classList.contains("menu-link"))
                                                ) {
                            ...
                            ,
                            {
                                key: "_unbindEvents", value: function () {
                                    this._evntElClick && (this._el.removeEventListener("click", this._evntElClick),
                                        (this._evntElClick = null)), this._evntElMouseOver && (this._el.removeEventListener("mouseover", this._evntElMouseOver),
                                            (this._evntElMouseOver = null)), this._evntElMouseOut && (this._el.removeEventListener("mouseout", this._evntElMouseOut),
                                                (this._evntElMouseOut = null)), this._evntWindowResize && (window.removeEventListener("resize", this._evntWindowResize),
                                                    (this._evntWindowResize = null)), this._evntBodyClick && (document.body.removeEventListener("click", this._evntBodyClick),
                                                        (this._evntBodyClick = null)), this._evntInnerMousemove && (this._inner.removeEventListener("mousemove", this._evntInnerMousemove),
                                                            (this._evntInnerMousemove = null)), this._evntInnerMouseleave && (this._inner.removeEventListener("mouseleave", this._evntInnerMouseleave),
                            ...
                            ,
                            {
                                key: "open", value: function (t) {
                                    var n = this, i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this._closeChildren, o = this._findUnopenedParent(e._getItem(t, !0), i);
                                    if (o) {
                            ...
                            ,
                            {
                                key: "close", value: function (t) {
                                    var n = this, i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this._closeChildren, o = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], r = e._getItem(t, !0), s = e._getLink(t, !0);
                            ...
                            ,
                            {
                                key: "toggle", value: function (t) {
                                    var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this._closeChildren, i = e._getItem(t, !0);
                            ...
                            ,
                            {
                                key: "_toggleDropdown", value: function (t, n, i) {
                                    ...
                                    if (t) {
                                        ...
                                        var l = Math.round(this._wrapper.getBoundingClientRect().width), a = this._innerPosition, u = this._getItemOffset(n), d = Math.round(n.getBoundingClientRect().width);
                                        ...
                                        s
                                            ...
                                            : u + this._innerPosition + c > l && c < l && c > d && (o.style[this._rtl ? "marginRight" : "marginLeft"] = "-".concat(c - d, "px")), this._closeOther(r, i), this._updateSlider();
                                    } else {
                                        var h = e._findChild(n, ["menu-toggle"]);
                                        if ((h.length && h[0].removeAttribute("data-hover", "true"), n.classList.remove("open"),
                                            (o.style[this._rtl ? "marginRight" : "marginLeft"] = null), i))
                            ...
                            ,
                            {
                                key: "_slide", value: function (e) {
                                    ...
                                    "next" === e ? i + (t = this._getSlideNextPos()) < n && (t = n - i) : (t = this._getSlidePrevPos()) > 0 && (t = 0),
                                        (this._innerPosition = t), this.update();
                                }
                                ,
                            }
                            ,
                            ...
                            ,
                            {
                                key: "_findUnopenedParent", value: function (t, n) {
                                    for (var i = [], o = null; t;) t.classList.contains("disabled") ? ((o = null),
                                        (i = [])) : (t.classList.contains("open") || (o = t), i.push(t)),
                            ...
                            ,
                            {
                                key: "_toggleAnimation", value: function (t, n, i) {
                                    ...
                                    var a = function () {
                                        n.classList.remove("menu-item-animating"), n.classList.remove("menu-item-closing"),
                                            (n.style.overflow = null),
                                            (n.style.height = null), o._horizontal || o.update();
                                    };
                                    t
                                        ? ((n.style.height = "".concat(l, "px")), n.classList.add("menu-item-animating"), n.classList.add("open"), e._bindAnimationEndEvent(n, function () {
                                            a(), o._onOpened(o, n, r, s);
                                        }), setTimeout(function () {
                                            n.style.height = "".concat(l + Math.round(s.getBoundingClientRect().height), "px");
                                        }
                                            , 50))
                                        : ((n.style.height = "".concat(l + Math.round(s.getBoundingClientRect().height), "px")), n.classList.add("menu-item-animating"), n.classList.add("menu-item-closing"), e._bindAnimationEndEvent(n, function () {
                            ...
                            ,
                            {
                                key: "_getItemOffset", value: function (e) {
                                    for (var t = this._inner.childNodes[0], n = 0; t !== e;) t.tagName && (n += Math.round(t.getBoundingClientRect().width)),
                                        (t = t.nextSibling);
                                    return n;
                                }
                                ,
                            ...
                            ,
                            {
                                key: "_updateSlider", value: function () {
                                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null, t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null, n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null, i = null !== e ? e : Math.round(this._wrapper.getBoundingClientRect().width), o = null !== t ? t : this._innerWidth, r = null !== n ? n : this._innerPosition;
                                    o < i || window.innerWidth < window.Helpers.LAYOUT_BREAKPOINT
                                        ...
                                        : (this._prevBtn.classList.remove("d-none"), this._nextBtn.classList.remove("d-none")), o > i &&
                            ...
                            ,
                            {
                                key: "update", value: function () {
                                    if (this._horizontal) {
                                        this.closeAll();
                                        var e = Math.round(this._wrapper.getBoundingClientRect().width), t = this._innerWidth, n = this._innerPosition;
                                        e - n > t && ((n = e - t) > 0 && (n = 0),
                                            (this._innerPosition = n)), this._updateSlider(e, t, n);
                            ...
                            ,
                            {
                                key: "manageScroll", value: function () {
                                    ...
                                    if (window.innerWidth < window.Helpers.LAYOUT_BREAKPOINT) null !== this._scrollbar && (this._scrollbar.destroy(),
                                        (this._scrollbar = null)), t.classList.add("overflow-auto");
                                    else {
                                        if (null === this._scrollbar) {
                                            var n = new e(document.querySelector(".menu-inner"),
                                                { suppressScrollX: !0, wheelPropagation: !1 });
                                            this._scrollbar = n;
                                        }
                            ...
                            ,
                            {
                                key: "switchMenu", value: function (e) {
                                    this._unbindEvents();
                                    var t = document.querySelector("nav.layout-navbar"), n = document.querySelector("#navbar-collapse"), o = document.querySelector("#layout-menu div"), r = document.querySelector("#layout-menu"), s = document.querySelector(".menu-horizontal-wrapper"), l = document.querySelector(".menu-inner"), a = document.querySelector(".app-brand"), u = document.querySelector(".layout-menu-toggle"), d = document.querySelectorAll(".menu-inner .active");
                                    if ("vertical" === e) {
                                        var c, h;
                                ...
                                key: "destroy", value: function () {
                                    if (this._el) {
                                        ...
                                        for (var t = this._el.querySelectorAll(".menu-item"), n = 0, i = t.length; n < i; n++)
                                            e._unbindAnimationEndEvent(t[n]), t[n].classList.remove("menu-item-animating"), t[n].classList.remove("open"),
                                                (t[n].style.overflow = null),
                                                (t[n].style.height = null);
                                        for (var o = this._el.querySelectorAll(".menu-menu"), r = 0, s = o.length; r < s; r++) (o[r].style.marginRight = null),
                                            (o[r].style.marginLeft = null);
                                        this._el.classList.remove("menu-no-animation"), this._wrapper &&
                                            (this._prevBtn.parentNode.removeChild(this._prevBtn), this._nextBtn.parentNode.removeChild(this._nextBtn), this._wrapper.parentNode.insertBefore(this._inner, this._wrapper), this._wrapper.parentNode.removeChild(this._wrapper), (this._inner.style.marginLeft = null), (this._inner.style.marginRight = null)), (this._el.menuInstance = null), delete this._el.menuInstance, (this._el = null), (this._horizontal = null), (this._animate = null), (this._accordion = null), (this._showDropdownOnHover = null), (this._closeChildren = null), (this._rtl = null), (this._onOpen = null), (this._onOpened = null), (this._onClose = null), (this._onClosed = null), this._scrollbar && (this._scrollbar.destroy(),
                                                (this._scrollbar = null)), (this._inner = null), (this._prevBtn = null), (this._wrapper = null), (this._nextBtn = null);
                                    }
                                }
                                ,
                            }
