    ...
    , (function () {
        ...
        window.templateCustomizer && (s && s.addEventListener("click", function () {
            ...
            , window.Helpers.isLightStyle()
                ? (s && (s.querySelector("i").classList.add("bx-moon"), new bootstrap.Tooltip(s, { title: "Dark mode", fallbackPlacements: ["bottom"] })), a("light"))
                : (s && (s.querySelector("i").classList.add("bx-sun"), new bootstrap.Tooltip(s, { title: "Light mode", fallbackPlacements: ["bottom"] })), a("dark")))

            , "undefined" != typeof i18next && "undefined" != typeof i18nextXHRBackend && i18next
        ...
        if ((isRtl && Helpers._addClass("dropdown-menu-end", document.querySelectorAll("#layout-navbar .dropdown-menu"))
            ...
            , window.addEventListener("resize"
                , function (e) {
                    window.innerWidth >= window.Helpers.LAYOUT_BREAKPOINT && document.querySelector(".search-input-wrapper") &&
                        ...
                        setTimeout(function () {
                            window.innerWidth < window.Helpers.LAYOUT_BREAKPOINT
                                ? document.getElementById("layout-menu").classList.contains("menu-horizontal") && menu.switchMenu("vertical")
                                : document.getElementById("layout-menu").classList.contains("menu-vertical") && menu.switchMenu("horizontal");
                        }, 100);
                }
                , !0
            )
